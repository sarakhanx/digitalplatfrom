...
var acc_validator_credentials_1 = require("../lib/validators/acc-validator-credentials");
var trpc_1 = require("./trpc");
var server_1 = require("@trpc/server");
exports.authRouter = (0, trpc_1.router)({
    createPayLloadUser: trpc_1.publicProcedure.input(acc_validator_credentials_1.AuthCreadentialsValidator)
    ...
    signIn: trpc_1.publicProcedure.input(acc_validator_credentials_1.AuthCreadentialsValidator).mutation(function (_a) {
