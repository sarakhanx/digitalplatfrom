...
exports.paymentRouter = (0, trpc_1.router)({
    createSession: trpc_1.privateProcedure
        ...
        return __awaiter(void 0, void 0, void 0, function () {
            var user, productIds, payload, products, fillterProduct, order, line_items, stripeSession, err_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        fillterProduct = products.filter(function (prod) { return Boolean(prod.priceId); });
                        return [4 /*yield*/, payload.create({
                                collection: "orders",
                                data: {
                                    _isPaid: false,
                                    products: fillterProduct.map(function (prod) { return prod.id; }),
                                    user: user.id,
                                },
                            })];
                    case 3:
                        order = _b.sent();
                        line_items = [];
                        fillterProduct.forEach(function (products) {
                            line_items.push({
                        ...
                        line_items.push({
                            price: "price_1OUTdDL7S43XLCzpRQOEGjPa",
                            quantity: 1,
                            adjustable_quantity: {
                                enabled: false
                            },
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, stripe_1.stripe.checkout.sessions.create({
                                ...
                                payment_method_types: ['card'], //สามารถเพิ่ม alipay หรือ wallet อื่นๆได้ อ่าน docs เพิ่ม
                                mode: "payment",
                                metadata: {
                                    userId: user.id,
                                    orderId: order.id
