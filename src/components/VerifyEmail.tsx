  ...
  if (isError) {
    return (
      <div className="flex flex-col items-center gap-2">
        ...
        <h3 className="font-semibold text-xl">There was the problem</h3>
        <p className="text-muted-foreground text-sm">
          This token might be wrongs or expired
        </p>
      </div>
    );
  }
    ...
    return (
      <div className="flex h-full flex-col items-center justify-center">
        <div className="relative mb-4 h-80 w-80 text-muted-foreground">
          <Image src="/verify-email.jpg" fill alt="the email was sent" />
        </div>
